...
#wget -q -O /etc/nginx/conf.d/xray.conf "https://raw.githubusercontent.com/syakira09/Marzban-Dug-V1.2/main/xray.conf"
#sed -i 's/kiko8.pisces.my.id/${domain}/g' /etc/nginx/conf.d/xray.conf
wget -q -O tesidom.sh https://raw.githubusercontent.com/syakira09/Marzban-Dug-V1.2/main/tesidom.sh && chmod +x tesidom.sh && ./tesidom.sh
sleep 1
...
wget -q -O /root/marzban/xray_config.json "https://raw.githubusercontent.com/amarukael/config/main/config.json"
docker compose up -d
clear 
